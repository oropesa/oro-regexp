...
describe('regexp DATETIME_FN_STRICT', () => {
  ...
  test('regexp DATETIME_FN_STRICT( str datetime w sec default )', () => {
    expect(REGEXP.DATETIME_FN_STRICT().test('31122019 12:45:53')).toBe(true);
    expect(REGEXP_DATETIME_FN_STRICT().test('31122019 12:45:53')).toBe(true);
  });
});
