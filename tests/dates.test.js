...
describe('regexp DATETIME_FN_STRICT', () => {
    test( 'regexp DATETIME_FN_STRICT( undefined ) '              , ( ) => { expect( REGEXP.DATETIME_FN_STRICT( '.' ).test() ) .toBe( false ) } ) ;
    test( 'regexp DATETIME_FN_STRICT( str bad sep ) '            , ( ) => { expect( REGEXP.DATETIME_FN_STRICT( '.' ).test( '05-06-2019'          ) ) .toBe( false ) } ) ;
    test( 'regexp DATETIME_FN_STRICT( str bad 0day ) '           , ( ) => { expect( REGEXP.DATETIME_FN_STRICT( '.' ).test( '00.02.2020'          ) ) .toBe( false ) } ) ;
    test( 'regexp DATETIME_FN_STRICT( str bad 2day ) '           , ( ) => { expect( REGEXP.DATETIME_FN_STRICT( '.' ).test( '5.06.2019'           ) ) .toBe( false ) } ) ;
    test( 'regexp DATETIME_FN_STRICT( str bad 2month ) '         , ( ) => { expect( REGEXP.DATETIME_FN_STRICT( '.' ).test( '05.6.2019'           ) ) .toBe( false ) } ) ;
    test( 'regexp DATETIME_FN_STRICT( str bad 4year ) '          , ( ) => { expect( REGEXP.DATETIME_FN_STRICT( '.' ).test( '05.06.19'            ) ) .toBe( false ) } ) ;
    test( 'regexp DATETIME_FN_STRICT( str date ) '               , ( ) => { expect( REGEXP.DATETIME_FN_STRICT( '.' ).test( '05.06.2019'          ) ) .toBe( false ) } ) ;
    test( 'regexp DATETIME_FN_STRICT( str bad 29-2 ) '           , ( ) => { expect( REGEXP.DATETIME_FN_STRICT( '.' ).test( '29.02.2019'          ) ) .toBe( false ) } ) ;
    test( 'regexp DATETIME_FN_STRICT( str ok 29-2 ) '            , ( ) => { expect( REGEXP.DATETIME_FN_STRICT( '.' ).test( '29.02.2020'          ) ) .toBe( false ) } ) ;
    test( 'regexp DATETIME_FN_STRICT( str date last ) '          , ( ) => { expect( REGEXP.DATETIME_FN_STRICT( '.' ).test( '31.12.2019'          ) ) .toBe( false ) } ) ;
    test( 'regexp DATETIME_FN_STRICT( str time ) '               , ( ) => { expect( REGEXP.DATETIME_FN_STRICT( '.' ).test( '12:45:53'            ) ) .toBe( false ) } ) ;
    test( 'regexp DATETIME_FN_STRICT( str bad datetime hour ) '  , ( ) => { expect( REGEXP.DATETIME_FN_STRICT( '.' ).test( '31.12.2019 12'       ) ) .toBe( false ) } ) ;
    test( 'regexp DATETIME_FN_STRICT( str bad datetime hour2 ) ' , ( ) => { expect( REGEXP.DATETIME_FN_STRICT( '.' ).test( '31.12.2019 2:45'     ) ) .toBe( false ) } ) ;
    test( 'regexp DATETIME_FN_STRICT( str bad datetime min ) '   , ( ) => { expect( REGEXP.DATETIME_FN_STRICT( '.' ).test( '31.12.2019 02:4'     ) ) .toBe( false ) } ) ;
    test( 'regexp DATETIME_FN_STRICT( str bad datetime min2 ) '  , ( ) => { expect( REGEXP.DATETIME_FN_STRICT( '.' ).test( '31.12.2019 12:45:'   ) ) .toBe( false ) } ) ;
    test( 'regexp DATETIME_FN_STRICT( str datetime w/o sec ) '   , ( ) => { expect( REGEXP.DATETIME_FN_STRICT( '.' ).test( '31.12.2019 12:45'    ) ) .toBe( true ) } ) ;
    test( 'regexp DATETIME_FN_STRICT( str datetime w sec   ) '   , ( ) => { expect( REGEXP.DATETIME_FN_STRICT( '.' ).test( '31.12.2019 12:45:53' ) ) .toBe( true ) } ) ;
});
...
describe('regexp DATETIME_FN', () => {
    test( 'regexp DATETIME_FN( undefined ) '              , ( ) => { expect( REGEXP.DATETIME_FN( '.' ).test() ) .toBe( false ) } ) ;
    test( 'regexp DATETIME_FN( str bad sep ) '            , ( ) => { expect( REGEXP.DATETIME_FN( '.' ).test( '05-06-2019'          ) ) .toBe( false ) } ) ;
    test( 'regexp DATETIME_FN( str bad 0day ) '           , ( ) => { expect( REGEXP.DATETIME_FN( '.' ).test( '00.02.2020'          ) ) .toBe( false ) } ) ;
    test( 'regexp DATETIME_FN( str bad 2day ) '           , ( ) => { expect( REGEXP.DATETIME_FN( '.' ).test( '5.06.2019'           ) ) .toBe( false ) } ) ;
    test( 'regexp DATETIME_FN( str bad 2month ) '         , ( ) => { expect( REGEXP.DATETIME_FN( '.' ).test( '05.6.2019'           ) ) .toBe( false ) } ) ;
    test( 'regexp DATETIME_FN( str bad 4year ) '          , ( ) => { expect( REGEXP.DATETIME_FN( '.' ).test( '05.06.19'            ) ) .toBe( false ) } ) ;
    test( 'regexp DATETIME_FN( str date ) '               , ( ) => { expect( REGEXP.DATETIME_FN( '.' ).test( '05.06.2019'          ) ) .toBe( true ) } ) ;
    test( 'regexp DATETIME_FN( str bad 29-2 ) '           , ( ) => { expect( REGEXP.DATETIME_FN( '.' ).test( '29.02.2019'          ) ) .toBe( false ) } ) ;
    test( 'regexp DATETIME_FN( str ok 29-2 ) '            , ( ) => { expect( REGEXP.DATETIME_FN( '.' ).test( '29.02.2020'          ) ) .toBe( true ) } ) ;
    test( 'regexp DATETIME_FN( str date last ) '          , ( ) => { expect( REGEXP.DATETIME_FN( '.' ).test( '31.12.2019'          ) ) .toBe( true ) } ) ;
    test( 'regexp DATETIME_FN( str time ) '               , ( ) => { expect( REGEXP.DATETIME_FN( '.' ).test( '12:45:53'            ) ) .toBe( false ) } ) ;
    test( 'regexp DATETIME_FN( str bad datetime hour ) '  , ( ) => { expect( REGEXP.DATETIME_FN( '.' ).test( '31.12.2019 12'       ) ) .toBe( false ) } ) ;
    test( 'regexp DATETIME_FN( str bad datetime hour2 ) ' , ( ) => { expect( REGEXP.DATETIME_FN( '.' ).test( '31.12.2019 2:45'     ) ) .toBe( false ) } ) ;
    test( 'regexp DATETIME_FN( str bad datetime min ) '   , ( ) => { expect( REGEXP.DATETIME_FN( '.' ).test( '31.12.2019 02:4'     ) ) .toBe( false ) } ) ;
    test( 'regexp DATETIME_FN( str bad datetime min2 ) '  , ( ) => { expect( REGEXP.DATETIME_FN( '.' ).test( '31.12.2019 12:45:'   ) ) .toBe( false ) } ) ;
    test( 'regexp DATETIME_FN( str datetime w/o sec ) '   , ( ) => { expect( REGEXP.DATETIME_FN( '.' ).test( '31.12.2019 12:45'    ) ) .toBe( true ) } ) ;
    test( 'regexp DATETIME_FN( str datetime w sec   ) '   , ( ) => { expect( REGEXP.DATETIME_FN( '.' ).test( '31.12.2019 12:45:53' ) ) .toBe( true ) } ) ;
});
...
describe('regexp DATE_FN', () => {
    test( 'regexp DATE_FN( undefined ) '              , ( ) => { expect( REGEXP.DATE_FN( '.' ).test() ) .toBe( false ) } ) ;
    test( 'regexp DATE_FN( str bad sep ) '            , ( ) => { expect( REGEXP.DATE_FN( '.' ).test( '05-06-2019'          ) ) .toBe( false ) } ) ;
    test( 'regexp DATE_FN( str bad 0day ) '           , ( ) => { expect( REGEXP.DATE_FN( '.' ).test( '00.02.2020'          ) ) .toBe( false ) } ) ;
    test( 'regexp DATE_FN( str bad 2day ) '           , ( ) => { expect( REGEXP.DATE_FN( '.' ).test( '5.06.2019'           ) ) .toBe( false ) } ) ;
    test( 'regexp DATE_FN( str bad 2month ) '         , ( ) => { expect( REGEXP.DATE_FN( '.' ).test( '05.6.2019'           ) ) .toBe( false ) } ) ;
    test( 'regexp DATE_FN( str bad 4year ) '          , ( ) => { expect( REGEXP.DATE_FN( '.' ).test( '05.06.19'            ) ) .toBe( false ) } ) ;
    test( 'regexp DATE_FN( str date ) '               , ( ) => { expect( REGEXP.DATE_FN( '.' ).test( '05.06.2019'          ) ) .toBe( true ) } ) ;
    test( 'regexp DATE_FN( str bad 29-2 ) '           , ( ) => { expect( REGEXP.DATE_FN( '.' ).test( '29.02.2019'          ) ) .toBe( false ) } ) ;
    test( 'regexp DATE_FN( str ok 29-2 ) '            , ( ) => { expect( REGEXP.DATE_FN( '.' ).test( '29.02.2020'          ) ) .toBe( true ) } ) ;
    test( 'regexp DATE_FN( str date last ) '          , ( ) => { expect( REGEXP.DATE_FN( '.' ).test( '31.12.2019'          ) ) .toBe( true ) } ) ;
    test( 'regexp DATE_FN( str time ) '               , ( ) => { expect( REGEXP.DATE_FN( '.' ).test( '12:45:53'            ) ) .toBe( false ) } ) ;
    test( 'regexp DATE_FN( str bad datetime hour ) '  , ( ) => { expect( REGEXP.DATE_FN( '.' ).test( '31.12.2019 12'       ) ) .toBe( false ) } ) ;
    test( 'regexp DATE_FN( str bad datetime hour2 ) ' , ( ) => { expect( REGEXP.DATE_FN( '.' ).test( '31.12.2019 2:45'     ) ) .toBe( false ) } ) ;
    test( 'regexp DATE_FN( str bad datetime min ) '   , ( ) => { expect( REGEXP.DATE_FN( '.' ).test( '31.12.2019 02:4'     ) ) .toBe( false ) } ) ;
    test( 'regexp DATE_FN( str bad datetime min2 ) '  , ( ) => { expect( REGEXP.DATE_FN( '.' ).test( '31.12.2019 12:45:'   ) ) .toBe( false ) } ) ;
    test( 'regexp DATE_FN( str datetime w/o sec ) '   , ( ) => { expect( REGEXP.DATE_FN( '.' ).test( '31.12.2019 12:45'    ) ) .toBe( false ) } ) ;
    test( 'regexp DATE_FN( str datetime w sec   ) '   , ( ) => { expect( REGEXP.DATE_FN( '.' ).test( '31.12.2019 12:45:53' ) ) .toBe( false ) } ) ;
});
